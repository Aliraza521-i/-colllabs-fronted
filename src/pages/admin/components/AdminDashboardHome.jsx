          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Website Approvals</p>
                  <p className="text-sm text-gray-500">Pending verification</p>
                </div>
              </div>
              <span className="text-lg font-semibold text-gray-900">{pendingActions.websiteApprovals || 0}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Withdrawal Requests</p>
                  <p className="text-sm text-gray-500">Awaiting processing</p>
                </div>
              </div>
              <span className="text-lg font-semibold text-gray-900">{pendingActions.withdrawalRequests || 0}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
              ...
              <span className="text-lg font-semibold text-gray-900">{pendingActions.supportTickets || 0}</span>
            </div>
          </div>
        </div>
      </div>
